class User < ActiveRecord::Base
  ...
  # Create activation token before creating a User
  ...
  # Parameter attribute generalizes the method to accept any type,
  # e.g. activation_digest
